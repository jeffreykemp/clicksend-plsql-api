...
begin
  ...
  logger.append_param(params,'p_payload.mobile',p_payload.mobile);
  ...
  begin
    ...
    apex_json.open_object;
      ...
      apex_json.open_array('messages');
        ...
        apex_json.write('to', p_payload.mobile);
...
function local_to_intnl_au (p_mobile in varchar2) return varchar2 is
...
begin
  ...
  payload := t_clicksend_msg
    ...
    ,sender        => sender
    ,mobile        => local_to_intnl_au(p_mobile)
    ,subject       => ''
    ,message       => p_message
    ,media_file    => ''
    ,voice_lang    => ''
